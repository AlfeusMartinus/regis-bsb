            ...
            <div className="relative w-full max-w-[520px] rounded-2xl bg-white dark:bg-[#1a2c22] shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden transform transition-all duration-500 ease-out translate-y-0 opacity-100 animate-[fadeIn_0.5s_ease-out]">
                ...
                <div className="flex flex-col items-center px-8 py-10 sm:px-12 sm:py-14 text-center">
                    ...
                    <div className="flex w-full flex-col gap-4">
                        <a
                            href="https://chat.whatsapp.com/Dxy9vWzKd7f9mu3KOpR2B2?mode=gi_t"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative flex w-full items-center justify-center gap-3 rounded-lg bg-primary py-3.5 px-6 text-sm font-bold text-background-dark shadow-lg shadow-primary/25 transition-all hover:-translate-y-0.5 hover:shadow-primary/40 focus:ring-4 focus:ring-primary/30"
                        >
